...
def generate_report():
    ...
    max_cov = blue.budget
    posture_score = round((total_cov / max_cov) * 100) if max_cov > 0 else 0
...
def render_html(report):
    ...
    shock_html = f"""
        ...
        <ul>
            ...
            <li>Adaptation latency: <b>{shock["adaptation_latency"]} rounds</b></li>
            <li>Recovered risk: <b>{shock["recovered_risk"] if shock["recovered_risk"] else "N/A"}</b></li>
        </ul>
    """
